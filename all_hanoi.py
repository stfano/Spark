...
def update_stock_data():
    ...
    now_time_local = datetime.now(vietnam_timezone)
    one_day_ago_local = now_time_local - timedelta(days=1)
    formatted_time_local = one_day_ago_local.strftime("%Y%m%d%H%M")
    ...
    for code in tqdm(reutersCode):
        url = f"https://api.stock.naver.com/chart/foreign/item/{code}/day?startDateTime=197001250000&endDateTime={now_time_vietnam}"
